...
,
  ...
  render() {
    ...
    <Text style={{left: 10, color: 'white', fontWeight: 'bold' }}>జన్మస్థానం</Text></Col><Col><Row><Text>{this.state.Bcoord.latitude}</Text></Row><Row><Text>{this.state.Bcoord.longitude}</Text></Row></Col>
             </Row>
